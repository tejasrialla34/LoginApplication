    ...
    : QMainWindow(parent)
{
    QLabel *l=new QLabel(this);
        ...
        l->move(100,50);
        QPixmap p("C:/Users/Lenovo/OneDrive/Documents/SimpleLoginForm/login.png");
        l->setPixmap(p.scaled(20,20));

        QLabel *lb=new QLabel(this);
        lb->move(180,25);
        lb->setAlignment(Qt::AlignHCenter);
        QPixmap pi("C:/Users/Lenovo/OneDrive/Documents/SimpleLoginForm/username.png");
        ...
        QPixmap pix("C:/Users/Lenovo/OneDrive/Documents/SimpleLoginForm/password.png");
